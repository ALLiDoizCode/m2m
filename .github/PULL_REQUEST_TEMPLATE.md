...
If you must bypass hooks, use `--no-verify` and document why below.

⚠️ **Warning:** Bypassing hooks increases risk of CI failure. Use sparingly.

**Reason for bypassing hooks:**

(Leave blank if hooks were not bypassed)
