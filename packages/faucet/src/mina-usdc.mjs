...
// `FungibleToken`. The mint core itself mirrors `tools/mina/fund-usdc.mts`
 ...
 * Mirrors `packages/mina-zkapp/src/usdc-deploy.ts` MINT_FEE_NANOMINA.
 */
 ...
 * token-account creation fee on first mint). Mirrors usdc-deploy.ts `mintUsdc()`.
 *
