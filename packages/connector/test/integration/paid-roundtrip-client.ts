 ...
 */
export const CONNECTOR_EVM_ADDRESS = '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266';
...
export class PaidRoundTripClient {
  ...
  private buildConfig(): ConnectorConfig {
    ...
    return {
      ...
      peers: [
        {
          // The single peer represents the CONNECTOR. We never BTP-connect to it
  ...
  async start(channelOpenTimeoutMs = 90_000): Promise<void> {
    ...
    this.claimSvc = new PerPacketClaimService(
      ...
      new Map([[CONNECTOR_PEER_ID, `evm:${ANVIL_CHAIN_ID}`]])
    );
  }
