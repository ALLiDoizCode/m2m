...
//! 0005, `docs/protocol/peer-semantics-spec.md` §3.2-§3.5,
//! `docs/protocol/client-edge-spec.md` §1.3, issues #423, #522). Pure, no
//! I/O -- a claim's signature is chain-specific (peer-semantics-spec.md §3.5,
...
/// peer-semantics-spec.md §3.4's `nonce_not_advancing`/`amount_not_advancing`
