...
44 records, and they do **three different jobs**. Most readers only need one group.
...
| If you are…                                                                 | Read                                                               |
| --------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| changing the connector's code or structure                                  | **[Connector architecture](#connector-architecture)** — 15 records |
| writing or fixing another implementation (a client SDK, a second connector) | **[Protocol law](#protocol-law)** — 25 records                     |
...
| [0037](0037-a-purchased-peering-is-a-terminated-route-whose-work-is-a-table-write.md) | A purchased peering is a terminated route whose work is a table write  | **removed by 0043** — kept for why a purchase was shaped this way |
| [0038](0038-a-peer-sale-lease-demotes-at-match-time-and-reaps-off-the-hot-path.md)    | A peer-sale lease demotes at match time and reaps off the hot path     | **removed by 0043** — with the row shape it gave expiry to        |
| [0039](0039-abuse-bounds-on-a-purchased-peering-refuse-not-refund.md)                 | Abuse bounds on a purchased peering refuse, not refund                 | **removed by 0043** — "refuse, not refund" survives as principle  |
| [0043](0043-purchasable-peering-is-removed.md)                                        | Purchasable peering is removed                                         | current — removes 0037, 0038, 0039                                |
...
| [0010](0010-flat-per-packet-fee-and-minimum-delivery.md)                         | A hop charges a flat per-packet fee; packets declare a minimum delivery              | current — amended by 0042: a fee is earned when the packet is paid for, not on fulfilment                           |
| [0011](0011-rejects-accumulate-fees-and-probes-discover-cost.md)                 | Rejects accumulate fees; a probe is how cost is discovered                           | current — amended by 0042: fee honesty is bounded, not self-enforcing                                               |
| [0044](0044-a-probe-answers-what-a-route-costs-and-what-it-does.md)              | A probe answers what a route costs and what it does                                  | current — extends 0011, 0022                                                                                        |
...
Ten records are still authoritative in part but argue from premises that later records
...
| 0037   | [0043](0043-purchasable-peering-is-removed.md)                                                                            |
| 0038   | [0043](0043-purchasable-peering-is-removed.md)                                                                            |
| 0039   | [0043](0043-purchasable-peering-is-removed.md)                                                                            |
