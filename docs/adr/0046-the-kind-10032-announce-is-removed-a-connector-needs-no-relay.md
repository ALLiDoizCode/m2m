...
**Status:** Accepted. **Retires [0030](0030-an-operator-announces-a-node-the-node-still-does-not.md) in full.** Restores [0022](0022-a-connector-answers-it-does-not-announce.md) and [0006](0006-the-connector-is-mechanism-not-policy.md) without qualification: a connector answers, and does nothing else about being found. The `[announce]` section does **not** become a tombstone — two of its fields feed the packet path and are re-homed, see below.
