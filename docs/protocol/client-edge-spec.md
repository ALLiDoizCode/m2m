...
with the payer's identity from the channel's `[[client_channels]]`/chain-resolved record
(ADR 0036) — connector-side records, never a fact the app is told. (`GET /channels`/`GET /claims`
