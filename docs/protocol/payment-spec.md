...
> termination** and **not yet built for a forwarded arrival**. Until it is, forwarding runs the older
> model in which a claim trails its fulfilment. [ADR 0042](../adr/0042-a-packet-carries-its-claim.md)
> is a target record and says so; the lock epic (#1031) is the vehicle.
