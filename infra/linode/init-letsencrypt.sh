...
# NB: connector/relay-ws are added for the issue #222 app edge.
...
DOMAINS=("evm-rpc.${DOMAIN}" "solana-rpc.${DOMAIN}" "solana-ws.${DOMAIN}" "faucet.${DOMAIN}" "mina.${DOMAIN}" "connector.${DOMAIN}" "relay-ws.${DOMAIN}")
