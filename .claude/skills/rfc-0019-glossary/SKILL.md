...
description: Expert knowledge of Interledger RFC 0019 - Glossary of terms. Use when users ask about Interledger terminology, definitions, concepts, or need clarification on protocol-specific terms. Answers from the copy vendored in this repository at docs/rfcs/, which carries a TOON profile saying where this connector departs. Triggers on 'what is', 'define', 'terminology', or when unclear terms are used.
---

# RFC 0019: Glossary

**Read [`docs/rfcs/0019-glossary/0019-glossary.md`](../../../docs/rfcs/0019-glossary/0019-glossary.md).**
...
It gives you the field's vocabulary.
